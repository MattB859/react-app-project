      ...
      <div className='w-full h-[700px] bg-gray-900/90 absolute'>
        ...
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto z-10'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                ...
                <h1 className='py-3 text-5xl text-white md:text-6xl font-medium'>Secure Scalable Private Cloud Management</h1>
                <p className='text-1xl text-slate-100 my-2'>Whatever your cloud computing needs, our team 
                of experts can <br/> help you cost effectively and quickly transform your business.</p>
