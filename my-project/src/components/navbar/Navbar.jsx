...
return (
    <section className='w-screen h-[80px] z-50 bg-zinc-100 fixed drop-shadow-lg'>
        <div className='px-4 flex justify-between items-center w-full h-full'>
            <h1 className='text-3xl mr-28  font-bold sm:text-4xl logo'><span>e</span>CLOUD</h1>
            <nav>
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full h-[500px] py-16 px-8'}>
            ...
            <li className='border-b-2 border-zinc-300 w-full text-2xl py-2'><Link onClick={handleClose} to="contact" smooth={true} offset={-50} duration={500}>Contact</Link></li>
